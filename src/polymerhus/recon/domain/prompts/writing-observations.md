...
- **Padding the list** - empty is a valid, frequent answer; low-signal observations pollute the graph. Missing a non-finding costs nothing; noise costs analyst attention.

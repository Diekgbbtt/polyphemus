...
by `polymerhus.recon.control.batching.build_jsluice_command`), not in the agent process. It
...
what `polymerhus.recon.domain.parsers.jsluice_parser.parse` already ingests.

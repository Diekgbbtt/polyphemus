...
plus the pinned ``steel_exec`` browser surface (version re-check, wait
ordering, session-name uniqueness, and the mandatory variadic ``--`` boundary,
D19), plus the #196 HTTP-history surface: ``search_http_history``,

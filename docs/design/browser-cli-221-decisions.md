...
Historical capture (2026-09-10, pre-D2-amendment and pre-D19): the command shapes below are shown as observed, not as canonical encodings.
A variadic verb shown without its `--` boundary predates D19 and must not be copied.
